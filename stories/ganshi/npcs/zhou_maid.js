...
export const zhou_maid = createNPC('zhou_maid', {
  name: '阿菊',
  title: '周家旧婢',
  dialogue: {
    ...
    save_bride: createDialogueNode('save_bride', {
    ...
    fox_link: createDialogueNode('fox_link', {
    ...
    fox_known: createDialogueNode('fox_known', {
    ...
    fox_hint: createDialogueNode('fox_hint', {
