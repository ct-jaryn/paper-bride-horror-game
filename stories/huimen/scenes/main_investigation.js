...
井水里忽然泛起一圈涟漪，像是有人在深处叹了口气。`,effects:{"sanity":-12,"yin":12,"addItem":"井壁长发","setFlag":"well_investigated"},choices:[createChoice({"text":"继续下井查看","next":"huimen_exp_well_night"}),createChoice({"text":"退后，去别处调查","next":"huimen_exp_village_street"})]}),
