...
你看见路边有一间敞开的门，门里点着一盏油灯。`,effects:{"sanity":-5,"yin":2},choices:[createChoice({"text":"进门躲雨","next":"huimen_exp_street_rain_shelter","effects":{"yin":2}}),createChoice({"text":"在雨里继续走","next":"huimen_exp_village_street","effects":{"sanity":-3,"yin":3}})]}),
    huimen_exp_street_rain_shelter: createScene('huimen_exp_street_rain_shelter', {title:'避雨',text:`你冲进那间屋子。
...
[red]你意识到，她不是活人，而是村子用来"留人"的饵。[/red]`,effects:{"sanity":-8,"yin":3},choices:[createChoice({"text":"吃一口汤圆","next":"huimen_exp_street_rain_eat","effects":{"sanity":-10,"yin":5}}),createChoice({"text":"转身离开","next":"huimen_exp_village_street","effects":{"sanity":3,"yin":-2}})]}),
    huimen_exp_street_rain_eat: createScene('huimen_exp_street_rain_eat', {title:'红汤圆',text:`你舀起一个汤圆，放进嘴里。
