...
"我等到了。" 她说，"三百年也值了。"`,effects:{"sanity":10,"yin":-10,"removeItem":"婚床上的字条"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_song_book: createScene('huimen_exp_village_street_song_book', {title:'歌本',text:`你在路边的垃圾堆里翻到一本旧歌本。
...
[red]你把歌本贴在胸口，像是贴着一颗三十年前的心。[/red]`,effects:{"sanity":-5,"yin":1,"addItem":"秀兰的歌本"},choices:[createChoice({"text":"把歌本给秀兰","next":"huimen_exp_village_street_song_book_give","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"收好","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
歌本化作一道光，没入井里。秀兰轻轻哼起了《兰花花》，声音清澈得像山间的溪水。`,effects:{"sanity":10,"yin":-10,"removeItem":"秀兰的歌本"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_embroidery: createScene('huimen_exp_village_street_embroidery', {title:'绣帕',text:`你看见窗台上放着一方绣帕。
...
帕子上的鸳鸯被血染红了一半，像是一对被迫分离的恋人。`,effects:{"sanity":-5,"yin":1,"addItem":"秀兰的绣帕"},choices:[createChoice({"text":"把绣帕给秀兰","next":"huimen_exp_village_street_embroidery_return","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"收好","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
"那我也算嫁过他了。" 她说。`,effects:{"sanity":10,"yin":-10,"removeItem":"秀兰的绣帕"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_lost_shoe: createScene('huimen_exp_village_street_lost_shoe', {title:'遗鞋',text:`石板路上有一只绣花鞋。
...
"我娘来送我了。" 秀兰说，"我可以走了。"`,effects:{"sanity":10,"yin":-10,"removeItem":"秀兰的布鞋"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
