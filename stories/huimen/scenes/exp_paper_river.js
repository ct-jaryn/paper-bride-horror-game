...
"别浪费。" 一个纸人说，"这些都是你的买命钱。"`,
        ...
        choices: [{"text":"用打火机烧纸钱","next":"huimen_exp_street_paper_rain_burn","condition":{"hasItem":"打火机"},"effects":{"sanity":-5,"yin":-5}},{"text":"把纸钱一张张撕碎","next":"huimen_exp_village_street","effects":{"sanity":-5,"yin":2}}],
    }
,
    huimen_exp_street_paper_rain_burn: {
        title: '焚钱',
        text: `你点燃打火机，火苗舔上纸钱。
...
你探头看，井水里浮着许多纸船，每一只船上都写着一个人的名字。`,
        ...
        choices: [{"text":"也折一只纸船放下去","next":"huimen_exp_street_paper_boat_make","effects":{"sanity":3,"yin":-3}},{"text":"离开井边","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
,
    huimen_exp_street_paper_boat_make: {
        title: '放船',
        text: `你捡起一张黄纸，折成一只小船。
...
你感到一阵轻松，像是把某种沉重的东西交给了水。`,
        effects: {"sanity":5,"yin":-5,"setFlag":"huimen_exp_sent_paper_boat"},
        choices: [{"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
};
