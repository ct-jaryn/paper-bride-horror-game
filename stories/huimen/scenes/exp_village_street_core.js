...
[red]这里可以通往村子的每个角落。[/red]`,
        ...
        choices: [
            ...
            {text:"去纸扎铺",next:"huimen_exp_paper_shop",effects:{yin:1}},
            {text:"去庙里",next:"huimen_exp_temple_gate",effects:{yin:1}},
            {text:"去祖祠",next:"huimen_exp_ancestral_hall",effects:{yin:1}},
            {text:"去桑树下",next:"huimen_exp_mulberry_tree",effects:{yin:1}},
            {text:"去废墟看看",next:"huimen_exp_ruins",effects:{yin:2}},
            {text:"顺着月光小路走",next:"huimen_exp_moonlit_path",effects:{yin:2}},
            {text:"调查村街四周",next:"huimen_exp_village_street_events_hub",effects:{yin:1}},
            {text:"寻找秀兰",next:"huimen_exp_village_street_xiulan_hub",effects:{yin:1},condition:{flag:"knowsTruth"}},
            {text:"探索更远的区域",next:"huimen_exp_village_street_districts_hub",effects:{yin:1}},
            {text:"天快亮了，村街的气氛变了",next:"huimen_exp_village_street_dawn",effects:{yin:1},condition:{timeAfter:120},hidden:true},
            {text:"子时到了，村子变得不对劲",next:"huimen_exp_village_street_midnight",effects:{yin:2},condition:{timeAfter:180},hidden:true},
            {text:"回老宅正堂，不在这里耽搁",next:"huimen_exp_return_old_house",effects:{yin:1}},
            {text:"去后院井边，用铜镜照一照",next:"huimen_exp_return_well",effects:{yin:1},condition:{hasItem:"铜镜碎片"}},
            {text:"该去开红棺了",next:"huimen_exp_return_red_coffin",effects:{yin:1},condition:{hasItem:"铜钥匙"}}
        ],
