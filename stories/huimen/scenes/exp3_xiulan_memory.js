...
你愣住。那眉眼，分明是年幼的秀兰。`,effects:{"sanity":3,"yin":1},choices:[createChoice({"text":"蹲下来，陪她绣花","next":"huimen_exp3_xiulan_memory_childhood_sew","effects":{"sanity":2,"yin":0}}),createChoice({"text":"问她长大后想做什么","next":"huimen_exp3_xiulan_memory_childhood_dream","effects":{"sanity":2,"yin":1}}),createChoice({"text":"悄悄退出门外","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
一阵风吹过，粗布上的影子晃了晃。小女孩忽然长大了些许，变成少女的轮廓。`,effects:{"sanity":2,"yin":1},choices:[createChoice({"text":"说你会带她去看戏","next":"huimen_exp3_xiulan_memory_childhood_promise","effects":{"sanity":3,"yin":1,"setFlag":"huimen_exp3_promised_xiulan_opera"}}),createChoice({"text":"沉默地看着她","next":"huimen_exp3_xiulan_memory_childhood_fade","effects":{"sanity":-2,"yin":2}})]}),
    huimen_exp3_xiulan_memory_childhood_dream: createScene('huimen_exp3_xiulan_memory_childhood_dream', {title:'她的愿望',text:`"我想开一家绣庄。"她把绣花绷子抱在胸前，"绣自己的花样，不用看婆婆脸色。"

她话音刚落，院墙上的青苔忽然蔓延，像是要把这座院子吞回时光里。`,effects:{"sanity":2,"yin":1},choices:[createChoice({"text":"告诉她，她的绣品以后会被人记住","next":"huimen_exp3_xiulan_memory_childhood_promise","effects":{"sanity":3,"yin":1}}),createChoice({"text":"起身离开院子","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
她的身影像被水晕开的墨，渐渐淡去。院里只剩一架织布机，还在空无一人的堂屋里"咔嗒咔嗒"地响。`,effects:{"sanity":3,"yin":1},choices:[createChoice({"text":"走进堂屋看织布机","next":"huimen_exp3_xiulan_memory_weaving","effects":{"yin":1}}),createChoice({"text":"带着绣品离开","next":"huimen_exp_village_street","effects":{"yin":1,"addItem":"秀兰的绣品"}})]}),
...
你捡起鞋面，发现上面绣的不是并蒂莲，是一口井。`,effects:{"sanity":-3,"yin":3},choices:[createChoice({"text":"离开","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
最后一幅画面停在一只红嫁衣上。嫁衣的袖口绣着井。`,effects:{"sanity":-2,"yin":2},choices:[createChoice({"text":"伸手触摸嫁衣","next":"huimen_exp3_xiulan_memory_wedding_night","effects":{"yin":2}}),createChoice({"text":"烧掉嫁衣","next":"huimen_exp3_xiulan_memory_weaving_burn","effects":{"sanity":5,"yin":-3}})]}),
...
你在灰烬里摸到一枚铜顶针，上面刻着一个小小的"秀"字。`,effects:{"sanity":5,"yin":-3,"addItem":"秀兰的顶针"},choices:[createChoice({"text":"离开","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
最后一刻，你听见她说："快跑，别让他们把我沉下去。"`,effects:{"sanity":-8,"yin":5},choices:[createChoice({"text":"从梦境中挣脱","next":"huimen_exp_village_street","effects":{"sanity":3,"yin":1}})]}),
    huimen_exp3_xiulan_memory_wedding_fear: createScene('huimen_exp3_xiulan_memory_wedding_fear', {title:'她的回答',text:`"怕。"秀兰的声音很轻，"但我更怕不被当成一个人。"

你隔着门说："你不是周家的物。你是秀兰。"

她沉默了很久。然后你听见她在门里轻轻笑了一声："谢谢你。很久没人叫我的名字了。"

门缝里滑出一张红纸，上面写着她真正的生辰八字。`,effects:{"sanity":5,"yin":-2,"setFlag":"huimen_exp3_knows_xiulan_birth"},choices:[createChoice({"text":"收起红纸，离开","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
你闭上嘴。人影失去了方向，像被风吹散的纸灰，一层层化进夜色里。`,effects:{"sanity":-3,"yin":3},choices:[createChoice({"text":"问她怎么才能救她","next":"huimen_exp3_xiulan_ask_save","effects":{"yin":1}})]}),
...
就在秀兰的手要触到井沿时，红绳断了。你向后跌倒，手里只剩半截湿漉漉的绳子。`,effects:{"sanity":-5,"yin":5,"addItem":"半截红绳"},choices:[createChoice({"text":"坐在井边","next":"huimen_exp3_xiulan_ask_save","effects":{"yin":1}})]}),
...
然后一只手搭上你的肩膀。秀兰的声音贴着你的耳垂响起："你不敢看，我不怪你。但你要记住这里。记住我。"`,effects:{"sanity":2,"yin":3},choices:[createChoice({"text":"睁开眼睛","next":"huimen_exp3_xiulan_ask_save","effects":{"yin":1}})]})
};
