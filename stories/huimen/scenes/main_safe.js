...
你吹灭蜡烛，把剩下的收好。剩下的不多了，你收得很小心，怕折断。`,effects:{"sanity":20,"time":15},choices:[createChoice({"text":"离开安全屋","next":"to_old_house"})]}),
...
老规矩。你不知道这规矩是谁定的，却觉得它管用。你又装了一小袋糯米随身带着，袋口扎得很紧，怕漏。`,effects:{"yin":-15,"time":10},choices:[createChoice({"text":"离开安全屋","next":"to_old_house"})]}),
...
你把护身符折好，贴身收着。它也许能在关键时刻替你挡一次灾。你收的时候，符纸"嗡"地响了一声，像是在应你。`,effects:{"sanity":10,"addItem":"护身符"},choices:[createChoice({"text":"离开安全屋","next":"to_old_house"})]})
};
