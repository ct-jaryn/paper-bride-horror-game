...
你感到桥栏上有力量在吸你的手。如果你再不松手，你的名字也会被刻上去。`,effects:{"sanity":-10,"yin":3},choices:[createChoice({"text":"咬破手指，在桥栏上写秀兰的名字","next":"huimen_exp_bridge_name","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"奋力挣脱，跑过桥去","next":"huimen_exp_moonlit_path_end","effects":{"sanity":-5,"yin":3}}),createChoice({"text":"退回桥头","next":"huimen_exp_moonlit_path","effects":{"yin":1}})]}),
    huimen_exp_moonlit_path_end: createScene('huimen_exp_moonlit_path_end', {title:'路尽',text:`你走到小路尽头。
...
你把那束枯桂花扶正，又从路边摘了一朵小白花放在上面。`,effects:{"sanity":3,"yin":-3},choices:[createChoice({"text":"在坟前磕个头","next":"huimen_exp_moonlit_grave_bow","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"继续往前走","next":"huimen_exp_moonlit_path_end","effects":{"yin":1}}),createChoice({"text":"在秀兰坟旁种一棵松树","next":"huimen_exp_little_pine_alt"})]}),
    huimen_exp_moonlit_grave_bow: createScene('huimen_exp_moonlit_grave_bow', {title:'无名祭',text:`你跪在坟前，磕了三个头。
...
她的身影消散在月光里。你站起身，感到胸口的压抑又轻了一些。`,effects:{"sanity":10,"yin":-8,"setFlag":"huimen_exp_honored_unknown_woman"},choices:[createChoice({"text":"继续往前走","next":"huimen_exp_moonlit_path_end","effects":{"yin":1}})]}),
...
可你知道，这条河不是给人渡的。它是给亡魂渡的。`,effects:{"sanity":-8,"yin":3},choices:[createChoice({"text":"找船渡河","next":"huimen_exp_moonlit_river_cross","effects":{"yin":3}}),createChoice({"text":"沿河岸走","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_moonlit_river_cross: createScene('huimen_exp_moonlit_river_cross', {title:'月夜渡河',text:`你找到一只小船，船夫是个穿蓑衣的老人。
...
你转而写下"周氏秀兰"四个字。河水翻涌，船却平稳地驶向对岸。`,effects:{"sanity":-5,"yin":2},choices:[createChoice({"text":"到对岸","next":"huimen_exp_moonlit_escape","effects":{"sanity":5,"yin":-5}})]}),
