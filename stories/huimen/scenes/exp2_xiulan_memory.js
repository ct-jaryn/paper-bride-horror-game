...
秀兰开心地笑了，那笑容里没有一丝阴霾，干净得像井里的水。她不知道，她绣的嫁衣，永远没有机会穿。`,effects:{"sanity":5,"yin":-5,"setFlag":"huimen_exp2_saw_xiulan_childhood"},choices:[createChoice({"text":"继续看她的后来","next":"huimen_exp2_xiulan_memory_love","effects":{"yin":1}}),createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
你拼命摇头，眼泪却流了下来。你知道，历史不能改变。你能做的，只是记住她此刻的笑容，记住这个还没有受过伤害的小女孩。`,effects:{"sanity":-5,"yin":3},choices:[createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
"不会。" 男子说，他的声音里有少年的坚定，"我一辈子都不会忘。我读完书，就回来娶你。"`,effects:{"sanity":-3,"yin":2},choices:[createChoice({"text":"继续看","next":"huimen_exp2_xiulan_memory_love_more","effects":{"yin":1}}),createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
[red]你认出那块玉佩。它在祖母的遗物里，用红布包着，三十年没动过。祖母临终前，把它塞进你手里，说："还给秀兰。"[/red]`,effects:{"sanity":-5,"yin":2,"addItem":"记忆中的玉佩（虚幻）"},choices:[createChoice({"text":"继续看下去","next":"huimen_exp2_xiulan_memory_pregnancy","effects":{"yin":1}}),createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp2_xiulan_memory_pregnancy: createScene('huimen_exp2_xiulan_memory_pregnancy', {title:'秀兰的记忆 · 怀孕',text:`画面来到一间小屋。

屋子不大，却收拾得干净。桌上放着一碗没吃完的桂花糕，旁边是一把剪刀和一块没剪完的布。秀兰坐在床边，手放在微微隆起的肚子上，脸上带着幸福的笑。
...
你再也说不出话。你想说"他会来的"，可你刚才已经说了实话。画面开始扭曲，桌上的桂花糕碎成一片，小衣服上的老虎也化了。秀兰的哭声像刀子一样，一下一下，刺进你心里。`,effects:{"sanity":-10,"yin":5},choices:[createChoice({"text":"继续看","next":"huimen_exp2_xiulan_memory_betrayal","effects":{"yin":1}}),createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
她的声音很轻，轻得像风。你泪流满面，却不敢出声，怕惊动她，怕让她知道，她的孩子永远等不到穿这件衣服的那一天。`,effects:{"sanity":-3,"yin":-5,"setFlag":"huimen_exp2_saw_xiulan_pregnancy"},choices:[createChoice({"text":"继续看","next":"huimen_exp2_xiulan_memory_betrayal","effects":{"yin":1}}),createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
[red]她最后看见周文，是在门缝里。他哭着看她，伸手要抓她，却被几个人按住。他的手指从门缝里伸出来，秀兰也伸手去抓——两根手指，差一点就够到了。[/red]`,effects:{"sanity":-15,"yin":5,"setFlag":"huimen_exp2_saw_xiulan_betrayal"},choices:[createChoice({"text":"退出这段痛苦的记忆","next":"huimen_exp_village_street","effects":{"yin":1}}),createChoice({"text":"抱住秀兰","next":"huimen_exp2_xiulan_memory_betrayal_hug","effects":{"sanity":-5,"yin":-5}})]}),
...
[red]可她还是穿着嫁衣，等到了天亮。她不愿意脱，像是脱了，就连最后的希望都没有了。[/red]`,effects:{"sanity":-5,"yin":-5,"setFlag":"huimen_exp2_saw_xiulan_wedding_wait"},choices:[createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
"谢谢你。" 她说，声音很轻，"至少有人知道我是怎么死的。"`,effects:{"sanity":-5,"yin":-5},choices:[createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
她的手最后松开了，松得很轻，像是一片叶子落下。`,effects:{"sanity":10,"yin":-10,"setFlag":"huimen_exp2_held_xiulan_in_well_memory"},choices:[createChoice({"text":"退出记忆","next":"huimen_exp_village_street","effects":{"yin":1}})]})
};
