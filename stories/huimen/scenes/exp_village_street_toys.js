...
export const scenes = {
    huimen_exp_village_street_paper_kite: createScene('huimen_exp_village_street_paper_kite', {title:'纸鸢',text:`你看见天上飞着一只纸鸢。
...
你感到胸口的压抑轻了一些，像是某种束缚也被剪断了。`,effects:{"sanity":10,"yin":-10,"setFlag":"huimen_exp_released_paper_kite"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_swing: createScene('huimen_exp_village_street_swing', {title:'秋千',text:`你来到一座小院前，院里有一架秋千。
...
你接住一缕头发，它在你手心里化为灰烬。`,effects:{"sanity":-5,"yin":-5,"setFlag":"huimen_exp_freed_swing_spirit"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_well_bucket: createScene('huimen_exp_village_street_well_bucket', {title:'井桶',text:`井边放着一个木桶。
...
"别扔。" 秀兰的声音说，"那是我的头发。"`,effects:{"sanity":-8,"yin":2,"addItem":"井桶里的头发"},choices:[createChoice({"text":"把头发还给秀兰","next":"huimen_exp_village_street_well_bucket_return","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"把桶放回原处","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
秀兰愣了一下，然后笑了："好。"`,effects:{"sanity":10,"yin":-10,"removeItem":"井桶里的头发","setFlag":"huimen_exp_combed_xiulan_hair"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_old_well: createScene('huimen_exp_village_street_old_well', {title:'旧井',text:`你找到另一口井。
...
你用手指描摹那些名字，感到一阵刺痛。`,effects:{"sanity":-10,"yin":3,"setFlag":"huimen_exp_saw_old_well_names"},choices:[createChoice({"text":"把\"贞烈\"二字凿掉","next":"huimen_exp_village_street_old_well_chisel","effects":{"sanity":-5,"yin":3}}),createChoice({"text":"离开","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
井底开始渗水，清澈的水，不是血。十二个女子的身影浮出来，朝你福了一福，然后消散。`,effects:{"sanity":10,"yin":-10,"setFlag":"huimen_exp_chiseled_old_well"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_village_street_paper_fan: createScene('huimen_exp_village_street_paper_fan', {title:'纸扇',text:`你看见地上有一把纸扇。
