...
export const scenes = {
    huimen_exp_ancestor_judge_scene: createScene('huimen_exp_ancestor_judge_scene', {title:'祖先',text:`你跪在牌位前，重重磕了三个头。
...
它朝你伸出手。那只手不是骨头，是无数根红绳缠成的。`,effects:{"sanity":-15,"yin":5},choices:[createChoice({"text":"答应以命换命","ending":"huimen_exp_ancestor_judge","effects":{"sanity":-10,"yin":5}}),createChoice({"text":"拒绝，冲出祖祠","next":"huimen_exp_village_street","effects":{"sanity":-5,"yin":3}})]}),
    huimen_exp_erase_name: createScene('huimen_exp_erase_name', {title:'抹名',text:`你把香灰涂在刻着自己名字的牌位上。
...
你捡起黄符，撕成两半。`,effects:{"sanity":10,"yin":-10,"removeItem":"香灰","setFlag":"huimen_exp_erased_name"},choices:[createChoice({"text":"离开祖祠","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_bridge_name: createScene('huimen_exp_bridge_name', {title:'桥刻名',text:`你咬破手指，在桥栏上写下"周氏秀兰"。
...
你把信放在女纸人手里。一阵风吹过，两个纸人倒在地上，化为灰烬。`,effects:{"sanity":-5,"yin":3,"addItem":"老槐树下未寄出的信"},choices:[createChoice({"text":"把信给秀兰","next":"huimen_exp_dawn_tree_give_letter","effects":{"yin":1}}),createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_dawn_tree_give_letter: createScene('huimen_exp_dawn_tree_give_letter', {title:'迟到的信',text:`你来到井边，把信放在井沿。
...
她的眼泪落进井里，井水变得清澈。`,effects:{"sanity":10,"yin":-10,"removeItem":"老槐树下未寄出的信","setFlag":"huimen_exp_gave_dawn_letter"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]})
};
