...
export const scenes = {
    huimen_exp_village_street_well_sound: {
        title: '井响',
        text: `你听见井里传来声音。
...
[red]你探头看，井壁上密密麻麻全是"秀兰"两个字。[/red]`,
        ...
        choices: [{"text":"对她说我记得你","next":"huimen_exp_village_street_well_sound_remember","effects":{"sanity":5,"yin":-5}},{"text":"离开","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
,
    huimen_exp_village_street_well_sound_remember: {
        title: '记得',
...
"我不需要再刻了。" 她说，"因为有人会记得我了。"`,
        effects: {"sanity":10,"yin":-10,"setFlag":"huimen_exp_xiulan_remembered"},
