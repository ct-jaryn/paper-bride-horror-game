...
[red]你感到一阵恶心。[/red]`,effects:{"sanity":-15,"yin":5,"setFlag":"huimen_exp2_heard_midwife_confession"},choices:[createChoice({"text":"告诉她去告诉秀兰真相","next":"huimen_exp2_midwife_release","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"冷冷地离开","next":"huimen_exp_village_street","effects":{"yin":3}})]}),
...
稳婆点点头，化作一缕青烟飘向井的方向。你感到屋里的药味淡了许多。`,effects:{"sanity":5,"yin":-10,"setFlag":"huimen_exp2_midwife_released"},choices:[createChoice({"text":"把稳婆的忏悔录下来带出村子","ending":"huimen_exp2_ending_midwife_secret","effects":{"yin":-5}}),createChoice({"text":"去井边看秀兰","next":"huimen_exp2_riverbank","effects":{"yin":1}}),createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp2_midwife_seal: createScene('huimen_exp2_midwife_seal', {title:'夺符',text:`你用力掰开稳婆的手，抢过黄符。

黄符一离开她的手，就燃烧起来。火光里，一个婴儿的虚影浮现出来，哇哇大哭。

"我的孩子！" 秀兰的声音从四面八方传来。

婴儿化作一道光，飞向井的方向。稳婆发出一声惨叫，身体化为灰烬。`,effects:{"sanity":-10,"yin":10},choices:[createChoice({"text":"追向井边","next":"huimen_exp2_riverbank","effects":{"yin":1}})]}),
...
[red]"母子俱亡"四个字，把两条命轻描淡写地抹去了。[/red]`,effects:{"sanity":-10,"yin":3,"addItem":"稳婆的接生记录"},choices:[createChoice({"text":"把记录带给秀兰","next":"huimen_exp2_riverbank","effects":{"sanity":5,"yin":-5,"removeItem":"稳婆的接生记录"}}),createChoice({"text":"收好","next":"huimen_exp2_midwife_house","effects":{"yin":1}})]}),
...
"那就赎罪。" 你说。`,effects:{"sanity":3,"yin":-3},choices:[createChoice({"text":"继续劝说","next":"huimen_exp2_midwife_confession","effects":{"yin":1}}),createChoice({"text":"离开","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp2_midwife_secret_room: createScene('huimen_exp2_midwife_secret_room', {title:'稳婆密室',text:`你在稳婆家的床板下发现一个暗格。

暗格里有一本日记，日记里记载着稳婆一生的秘密。你翻到民国二十三年那一页：

[faded]"今日为周家不祥女接生。孩子已出母腹，周老太爷亲手按死。我无力阻止，只能把孩子的脐带藏起。此罪此生难消。"[/faded]`,effects:{"sanity":-15,"yin":5,"setFlag":"huimen_exp2_found_midwife_secret"},choices:[createChoice({"text":"把日记给秀兰","next":"huimen_exp2_riverbank","effects":{"sanity":5,"yin":-5,"addItem":"稳婆日记"}}),createChoice({"text":"烧了日记","next":"huimen_exp2_midwife_house","effects":{"sanity":5,"yin":-3}})]})
};
