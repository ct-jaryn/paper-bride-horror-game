...
"回来啦。"他们说。`,effects:{"sanity":-10,"yin":3},choices:[createChoice({"text":"迈进老宅","next":"to_old_house","effects":{"yin":1}}),createChoice({"text":"先在门外观察","next":"to_old_house","effects":{"sanity":-3,"yin":1}}),createChoice({"text":"转身离开","next":"huimen_exp_village_street","effects":{"sanity":-5,"yin":5}})]}),
...
"三十年，"她说，"我等了三十年，就想听周家人说一句：你是我的。"`,effects:{"sanity":10,"yin":-15,"setFlag":"xiulanMercy"},choices:[createChoice({"text":"现在我可以带你走了","next":"huimen_prepare_burial","effects":{"yin":1}}),createChoice({"text":"先解开红棺的封印","next":"open_red_coffin","effects":{"yin":2}}),createChoice({"text":"让族谱上的所有女子都被看见","next":"huimen_exp_zhou_women_alt","effects":{"sanity":5,"yin":-5}})]}),
