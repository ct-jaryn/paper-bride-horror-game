...
[red]这是周文扎的替身，想替秀兰受过。[/red]`,
        effects: {"sanity":-5,"yin":2,"addItem":"周文的纸偶"},
        choices: [{"text":"把纸偶烧了","next":"huimen_exp2_ruins_doll_burn","effects":{"sanity":5,"yin":-5}},{"text":"把纸偶给秀兰","next":"huimen_exp2_riverbank","effects":{"sanity":10,"yin":-10,"removeItem":"周文的纸偶"}}],
    }
,
    huimen_exp2_ruins_doll_burn: {
        title: '废墟焚偶',
        text: `你点燃纸偶。
