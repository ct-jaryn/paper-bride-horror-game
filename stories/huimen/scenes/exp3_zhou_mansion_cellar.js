...
纸上的朱砂字蹭到你手上，像血一样红。`,effects:{"sanity":3,"yin":-2,"addItem":"秀兰生辰纸"},choices:[createChoice({"text":"去点灯","next":"huimen_exp3_zhou_mansion_cellar_light","effects":{"yin":1}}),createChoice({"text":"离开地窖","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
最里面的那口棺材是空的。`,effects:{"sanity":-5,"yin":5},choices:[createChoice({"text":"查看空棺材","next":"huimen_exp3_zhou_mansion_cellar_empty","effects":{"yin":2}}),createChoice({"text":"烧掉纸人","next":"huimen_exp3_zhou_mansion_cellar_burn","effects":{"sanity":8,"yin":-5}})]}),
...
你认出这是秀兰留的。她把一只鞋留在这里，作为还没被完全吞没的证据。`,effects:{"sanity":3,"yin":-2,"addItem":"秀兰的绣花鞋"},choices:[createChoice({"text":"把鞋收好，继续探索","next":"huimen_exp3_zhou_mansion_cellar_deep","effects":{"yin":1}})]}),
...
你感觉地窖里的阴气淡了许多。`,effects:{"sanity":8,"yin":-8,"setFlag":"huimen_exp3_burned_paper_brides"},choices:[createChoice({"text":"去石门","next":"huimen_exp3_zhou_mansion_cellar_deep","effects":{"yin":1}}),createChoice({"text":"离开地窖","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
她们齐声说："你终于来了。我们等了很久。"`,effects:{"sanity":-10,"yin":10},choices:[createChoice({"text":"问她们想要什么","next":"huimen_exp3_zhou_mansion_cellar_women_want","effects":{"yin":2}}),createChoice({"text":"转身逃跑","next":"huimen_exp3_ending_ancestral_cellar_scene","effects":{"yin":3}})]}),
...
门后的哭声停了片刻，然后一个声音说："那就把我们的名字念出来。念对了，门就让你进。念错了，你就留下陪我们。"`,effects:{"sanity":-2,"yin":4},choices:[createChoice({"text":"念秀兰的名字","next":"huimen_exp3_zhou_mansion_cellar_door_talk_xiulan","effects":{"yin":2}}),createChoice({"text":"念九个人的名字","next":"huimen_exp3_zhou_mansion_cellar_door_talk_nine","condition":{"flag":"huimen_exp3_knows_seven_women"},"effects":{"sanity":5,"yin":-2}})]}),
...
"秀兰说，你会来的。"那声音说，"我们让她先见你。"`,effects:{"sanity":-3,"yin":5},choices:[createChoice({"text":"走进石室","next":"huimen_exp3_zhou_mansion_cellar_women_want","effects":{"yin":1}})]}),
...
"给我们立个名。"她们说，"有名，才能走。"`,effects:{"sanity":5,"yin":-3},choices:[createChoice({"text":"在无字牌位上写下九个人的名字","next":"huimen_exp3_zhou_mansion_cellar_name_stele","effects":{"sanity":8,"yin":-5}})]}),
...
"帮我们刻回名字。"另一个身影说，"刻回名字，我们就放秀兰走。"`,effects:{"sanity":-3,"yin":5},choices:[createChoice({"text":"答应她们","next":"huimen_exp3_zhou_mansion_cellar_name_stele","effects":{"sanity":5,"yin":-2}}),createChoice({"text":"说只带秀兰走","next":"huimen_exp3_zhou_mansion_cellar_women_angry","effects":{"yin":8}})]}),
    huimen_exp3_zhou_mansion_cellar_women_angry: createScene('huimen_exp3_zhou_mansion_cellar_women_angry', {title:'众怒',text:`"只带她走？"女子们的声音重叠在一起，像井底的回声，"我们也是秀兰。我们也是被人忘了的秀兰。"

她们的影子朝你压过来，地窖里的温度骤降。你感觉呼吸开始困难，像是有水灌进肺里。`,effects:{"sanity":-8,"yin":8},choices:[createChoice({"text":"改口答应所有人","next":"huimen_exp3_zhou_mansion_cellar_name_stele","effects":{"sanity":3,"yin":-2}}),createChoice({"text":"拼死冲出地窖","next":"huimen_exp_village_street","effects":{"sanity":-5,"yin":5}})]}),
...
她伸出手，掌心里是一枚冰凉的骨片。`,effects:{"sanity":10,"yin":-10,"addItem":"秀兰骨片","setFlag":"huimen_exp3_freed_nine_women"},choices:[createChoice({"text":"握住她的手","next":"huimen_exp3_xiulan_hand","effects":{"sanity":5,"yin":-3}})]})
};
