...
export const scenes = {
    ...
    huimen_exp_return_red_coffin: createScene('huimen_exp_return_red_coffin', {title:"回红棺",text:"你顺着井绳下到井底。\n\n红漆棺材还在，九根桃木钉封着棺盖。你摸了摸胸口的铜钥匙，知道是时候了。\n\n秀兰的三份魂已经在另一个村子归一，但她真正的尸骨和怨念，还封在这口红棺里。\n\n[red]开棺，是结束一切的钥匙。[/red]",effects:{"sanity":-5,"yin":2},choices:[createChoice({"text":"继续主线","next":"open_red_coffin","effects":{"yin":1}}),createChoice({"text":"你已开过红棺，想再看一眼棺中物","next":"huimen_exp2_red_coffin_inside","condition":{"flag":"red_coffin_unlocked"},"hidden":true,"effects":{"yin":2}})]})
};
