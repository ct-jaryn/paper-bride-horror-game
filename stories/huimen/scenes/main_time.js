...
你摸了摸口袋里的东西，决定接下来的每一步都要更谨慎。`,effects:{"time":60,"setFlag":"shichen_hai"},choices:[createChoice({"text":"继续往老宅走","next":"to_old_house"}),createChoice({"text":"先调查一下村口","next":"huimen_exp_village_street"})]}),
...
你感到手腕上的脉搏，和某种更古老的心跳，渐渐重合。`,effects:{"time":60,"setFlag":"shichen_zi","yin":10},choices:[createChoice({"text":"靠近井口","next":"huimen_exp_well_night"}),createChoice({"text":"退回老宅","next":"to_old_house","effects":{"sanity":-5}})]}),
