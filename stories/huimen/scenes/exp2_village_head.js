...
村长的脸扭曲了："你以为你几句话就能翻案？周家养了三十年，就是为了今天！"`,effects:{"sanity":-10,"yin":3},choices:[createChoice({"text":"继续反驳","next":"huimen_exp2_village_head_refute","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"动手打他","ending":"huimen_exp2_ending_village_head_judge","effects":{"yin":5}}),createChoice({"text":"离开","next":"huimen_exp2_village_head_house","effects":{"yin":1}})]}),
    huimen_exp2_village_head_refute: createScene('huimen_exp2_village_head_refute', {title:'村长驳斥',text:`你说："周家欠秀兰的，不是名声，是命。你们帮周家杀人，你们也是凶手。"

院子里的村民开始骚动。有人低头，有人冷笑，有人哭泣。

村长拍案而起："住口！你以为你是谁？"

"我是周家的后人。" 你说，"但我不是周家的刀。"`,effects:{"sanity":5,"yin":-5,"setFlag":"huimen_exp2_confronted_village_head"},choices:[createChoice({"text":"索要族谱","next":"huimen_exp2_village_head_record","effects":{"yin":1}}),createChoice({"text":"离开","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
村长犹豫了一下，把族谱递给你。你翻开最后一页，上面果然压着许多女子的名字，每一个名字后面都写着"借命"。`,effects:{"sanity":-5,"yin":3,"addItem":"周家村族谱"},choices:[createChoice({"text":"撕掉借命那一页","next":"huimen_exp2_village_head_record_burn","effects":{"sanity":10,"yin":-10}}),createChoice({"text":"收好族谱","next":"huimen_exp2_village_head_house","effects":{"yin":1}})]}),
...
[red]你烧了周家村三百年的账。[/red]`,effects:{"sanity":-10,"yin":10},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp2_village_head_vault: createScene('huimen_exp2_village_head_vault', {title:'村长密室',text:`你在村长家的床底下发现一道暗门。

暗门通向一间密室，密室里堆满了金银财宝。每一锭银子下面都压着一张黄纸，纸上写着一个女子的名字。

[red]周家的财富，是女子的命换来的。[/red]`,effects:{"sanity":-10,"yin":5},choices:[createChoice({"text":"把财宝扔出密室","next":"huimen_exp2_village_head_vault_throw","effects":{"sanity":5,"yin":-5}}),createChoice({"text":"翻看黄纸","next":"huimen_exp2_village_head_vault_read","effects":{"yin":2}}),createChoice({"text":"离开","next":"huimen_exp2_village_head_house","effects":{"yin":1}})]}),
    huimen_exp2_village_head_vault_throw: createScene('huimen_exp2_village_head_vault_throw', {title:'扔银',text:`你抱起一锭银子，扔出密室。

银子落地，发出沉闷的响声。黄纸从银子下飘出来，像蝴蝶一样飞向空中。

"我们的钱，不要了。" 一个女子的声音说，"我们要的是名字。"`,effects:{"sanity":10,"yin":-10,"setFlag":"huimen_exp2_threw_village_head_silver"},choices:[createChoice({"text":"继续扔","next":"huimen_exp2_village_head_vault","effects":{"yin":-3}}),createChoice({"text":"离开","next":"huimen_exp2_village_head_house","effects":{"yin":1}})]}),
...
[red]原来她们的命，在周家眼里就这么便宜。[/red]`,effects:{"sanity":-10,"yin":3,"addItem":"周家女子命价单"},choices:[createChoice({"text":"把命价单贴到村口","next":"huimen_exp_village_street","effects":{"sanity":10,"yin":-10,"removeItem":"周家女子命价单","setFlag":"huimen_exp2_posted_price_list"}}),createChoice({"text":"收好","next":"huimen_exp2_village_head_vault","effects":{"yin":1}})]})
};
