...
你知道，那飞向远方的，是解脱。而那没入你胸口的，是周家血脉最后的诅咒，也是最后的救赎。`,
        effects: {"sanity":20,"yin":-30,"setFlag":"zhouDebtAcknowledged"},
        ending: 'hidden_zhouCurse',
    }
,
    huimen_exp_zhou_curse_alt: {
        title: '血脉',
...
但你不再害怕。因为只要你不忘，那些亡魂就不会真正消失。`,
        choices: [{"text":"接下这份债","ending":"hidden_zhouCurse"}],
    }
,
    huimen_exp_zhou_women_alt: {
        title: '女名墙',
...
"一直都是。"你说。`,
        choices: [{"text":"让她们被看见","ending":"hidden_zhouWomen"}],
    }
};
