...
"那就把你的名字刻上来。" 河神说，"刻一个名字，还一条命。"`,effects:{"sanity":-8,"yin":5},choices:[createChoice({"text":"刻秀兰的名字","next":"huimen_exp2_river_god_carve_xiulan","effects":{"sanity":5,"yin":-10}}),createChoice({"text":"刻自己的名字","next":"huimen_exp2_river_god_carve_self","effects":{"yin":10}})]}),
    huimen_exp2_river_god_carve_xiulan: createScene('huimen_exp2_river_god_carve_xiulan', {title:'河石刻名',text:`你用手指在石头上刻下"周氏秀兰"四个字。
...
[red]你成了周家又一个献祭给河的人。[/red]`,effects:{"sanity":-15,"yin":10},choices:[createChoice({"text":"挣脱","next":"huimen_exp2_riverbank","effects":{"sanity":-5,"yin":3}}),createChoice({"text":"放弃","ending":"huimen_exp2_ending_village_head_judge","effects":{"yin":5}})]}),
...
"真相。" 你说。`,effects:{"sanity":5,"yin":-5,"setFlag":"huimen_exp2_carved_river_god"},choices:[createChoice({"text":"继续刻","next":"huimen_exp2_river_god_carve_more","effects":{"sanity":-3,"yin":-3}}),createChoice({"text":"回河边","next":"huimen_exp2_riverbank","effects":{"yin":1}})]}),
...
"你替我们把名字刻在了河上。" 她们说，"河水会记住我们。"`,effects:{"sanity":10,"yin":-10,"setFlag":"huimen_exp2_carved_all_names_on_river"},choices:[createChoice({"text":"回河边","next":"huimen_exp2_riverbank","effects":{"yin":1}})]}),
    huimen_exp2_river_god_boats: createScene('huimen_exp2_river_god_boats', {title:'推船',text:`你把河神石周围的纸船一一推开。

每只船被你推开时，都会发出一声轻轻的叹息。你忽然意识到，这些船不是被困在这里，而是在等一个愿意推它们走的人。

"谢谢你。" 一个声音说，"我们等了三十年，终于等到有人愿意让我们走。"`,effects:{"sanity":5,"yin":-5},choices:[createChoice({"text":"继续推","next":"huimen_exp2_riverbank","effects":{"sanity":3,"yin":-3}}),createChoice({"text":"离开","next":"huimen_exp2_riverbank","effects":{"yin":1}})]})
};
