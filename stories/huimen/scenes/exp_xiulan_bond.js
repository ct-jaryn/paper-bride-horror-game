...
export const scenes = {
    huimen_exp_restore_xiulan_name: {
        title: '族谱正名',
        text: `你咬破手指，在空白页上写下：
...
你感到胸口的压抑彻底消散了。手腕上的红痕也变得温热，像是一个安心的印记。`,
        effects: {"sanity":15,"yin":-15,"setFlag":"huimen_exp_restored_xiulan_name_in_hall"},
        choices: [{"text":"离开祖祠","next":"huimen_exp_village_street","effects":{"yin":1}},{"text":"回老宅，把这件事告诉亲戚","next":"huimen_exp_return_coffin","effects":{"yin":1}}],
    }
,
    huimen_exp_xiulan_wish: {
        title: '秀兰的愿望',
        text: `秀兰想了很久。
...
[red]她的愿望很小，小到让人心碎。[/red]`,
        effects: {"sanity":-5,"yin":2,"setFlag":"huimen_exp_knows_xiulan_wish"},
        choices: [{"text":"答应帮她实现愿望","next":"huimen_exp_xiulan_wish_promise","effects":{"sanity":5,"yin":-5}},{"text":"沉默","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
,
    huimen_exp_xiulan_wish_promise: {
        title: '秀兰心愿承诺',
...
,
    huimen_exp_xiulan_outside_world: {
        title: '外面',
...
[red]她的声音很轻，却带着一种穿越三十年的渴望。[/red]`,
        ...
        choices: [{"text":"告诉她一定会的","next":"huimen_exp_village_street","effects":{"sanity":3,"yin":-3}}],
    }
,
    huimen_exp_xiulan_hair: {
        title: '梳头',
        text: `你坐在井边，给秀兰梳头。
...
[red]你梳了很久，直到她的头发顺得像一条黑色的河。[/red]`,
        effects: {"sanity":10,"yin":-10,"setFlag":"huimen_exp_combed_xiulan_hair_2"},
        choices: [{"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
,
    huimen_exp_use_xiulan_hair: {
        title: '缠发',
        text: `你取出秀兰的头发，握在手心。
...
头发化作一道红光，缠上你的手腕，像一根细细的红绳。`,
        effects: {"sanity":5,"yin":-5,"removeItem":"秀兰的头发","setFlag":"huimen_exp_wearing_xiulan_hair"},
        choices: [{"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
,
    huimen_exp_xiulan_name: {
        title: '名字',
        text: `你问秀兰："你的名字是谁取的？"
...
她又哭了，但这一次是笑着哭的。`,
        effects: {"sanity":10,"yin":-10,"setFlag":"huimen_exp_called_xiulan_name"},
        choices: [{"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}}],
    }
,
    huimen_exp_xiulan_age: {
        title: '年华',
