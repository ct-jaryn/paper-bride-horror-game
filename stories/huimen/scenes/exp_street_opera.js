...
[red]这是一件会自己唱戏的戏服。[/red]`,effects:{"sanity":-8,"yin":3},choices:[createChoice({"text":"鼓掌叫好","next":"huimen_exp_street_opera_tune_clap","effects":{"sanity":-3,"yin":2}}),createChoice({"text":"问它是不是秀兰","next":"huimen_exp_street_opera_tune_ask","effects":{"yin":2}})]}),
    huimen_exp_street_opera_tune_clap: createScene('huimen_exp_street_opera_tune_clap', {title:'戏散',text:`你鼓起掌来。
...
"是啊。" 柳红说，"周家的罪，不止这一个小山村。你若救秀兰，也救救我。把我的戏服带出村子，交给一个赶尸匠。他会懂。"`,effects:{"sanity":-5,"yin":3,"setFlag":"huimen_exp_met_liu_hong"},choices:[createChoice({"text":"答应她","next":"huimen_exp_village_street","effects":{"yin":1,"addItem":"柳红的戏服"}})]}),
...
鼓声就是从井底传来的，像是有一颗巨大的心脏在跳动。`,effects:{"sanity":-8,"yin":3},choices:[createChoice({"text":"掀开石板","next":"huimen_exp_street_drum_open","effects":{"sanity":-10,"yin":5}}),createChoice({"text":"把耳朵贴在石板上听","next":"huimen_exp_street_drum_listen","effects":{"yin":2}})]}),
    huimen_exp_street_drum_listen: createScene('huimen_exp_street_drum_listen', {title:'听鼓',text:`你把耳朵贴在石板上。
...
"你想让我们安静吗？" 一个声音问，"那就把我们的心放出去。"`,effects:{"sanity":-10,"yin":3,"setFlag":"huimen_exp_heard_village_heart"},choices:[createChoice({"text":"想办法掀开石板","next":"huimen_exp_street_drum_open","effects":{"yin":2}}),createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
    huimen_exp_street_drum_open: createScene('huimen_exp_street_drum_open', {title:'开井',text:`你用力掀开石板。
