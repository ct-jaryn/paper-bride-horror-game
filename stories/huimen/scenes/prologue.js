...
她的灯笼忽明忽暗，照得地上纸钱纷飞。那纸钱飘得不是随风乱转，而是齐刷刷朝村子里头飘，像有人在前头引路。`,effects:{"sanity":-5,"yin":5,"visual":"flicker","visualDuration":2000},choices:[createChoice({"text":"问她秀兰是谁","next":"ask_xiulan"}),createChoice({"text":"不理她，径直往老宅走","next":"huimen_village_gate"}),createChoice({"text":"仔细观察那两个纸人","next":"inspect_paper_dolls","effects":{"sanity":-8,"yin":2}}),createChoice({"text":"侧耳倾听，纸人似乎在低语","next":"paper_whisper","condition":{"yinAbove":15},"hidden":true,"effects":{"sanity":-5,"yin":5}}),createChoice({"text":"感觉时辰已晚，先在村口整理思绪","next":"shichen_hai_entry","condition":{"timeAfter":1200},"hidden":true,"effects":{"time":30}}),createChoice({"text":"老宅大门似乎被什么东西封住了","next":"old_house_door_locked"})],hallucination:'[whisper]你低头看自己的手，发现手腕上已经系了一根红绳。红绳的另一端，消失在夜色里。[/whisper]'})
};
