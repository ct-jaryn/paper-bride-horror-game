...
你拼命抓住井沿，指甲在石缝里抠出血痕。`,effects:{"sanity":-8,"yin":3,"visual":"blood","visualDuration":2000},choices:[createChoice({"text":"掏出铜镜碎片照向井底","next":"huimen_exp_well_reflection","condition":{"hasItem":"铜镜碎片"},"effects":{"sanity":3,"yin":-5}}),createChoice({"text":"用力挣脱井绳","next":"huimen_exp_village_street","effects":{"sanity":-5,"yin":2}}),createChoice({"text":"对着井水说话：\"我不是来娶你的\"","next":"huimen_exp_well_whisper","effects":{"sanity":-3,"yin":2}}),createChoice({"text":"抓着井绳下到井底看看","next":"huimen_exp_well_dive","effects":{"yin":2}}),createChoice({"text":"再下一次井，看看井壁上的字","next":"huimen_exp_well_bottom","condition":{"flag":"huimen_exp_sat_with_xiulan"},"effects":{"yin":1}}),createChoice({"text":"这里太危险，回老宅去","next":"huimen_exp_return_old_house","effects":{"yin":1}}),createChoice({"text":"下井","next":"huimen_exp3_well_bottom","effects":{"yin":3}}),createChoice({"text":"坐在井边，听她说","next":"huimen_exp_well_whisper_alt"}),createChoice({"text":"打开手机录音，把她说的话录下来","next":"huimen_exp_well_truth_record"}),createChoice({"text":"丑时到了，该去揭开真相","next":"shichen_chou_entry","condition":{"timeAfter":1500},"hidden":true,"effects":{"time":30}}),createChoice({"text":"趴在井口做详细调查","next":"investigate_well"}),createChoice({"text":"井沿上蹲着一个浣洗衣裳的女子虚影","npc":"a_huan","npcNode":"start","effects":{"yin":1},"custom":true})],hallucination:'[whisper]井水里的红轿子掀开帘，里面坐着的不是秀兰，是你自己。[/whisper]'}),
...
[red]你还有机会用铜镜照她，或者听她说话。[/red]`,effects:{"sanity":-3,"yin":1},choices:[createChoice({"text":"继续主线","next":"mirror_well","effects":{"yin":1}})]}),
...
你下到井底，脚踩到了硬物。那是一口红漆棺材，棺材上钉着九根桃木钉。`,effects:{"sanity":-10,"yin":3},choices:[createChoice({"text":"这就回去拿钥匙","next":"huimen_exp_return_red_coffin","condition":{"hasItem":"铜钥匙"},"effects":{"yin":1}}),createChoice({"text":"没有钥匙，先上去","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
...
你在那行字旁边，刻下了新的字："秀兰，我记住你了。"`,effects:{"sanity":-5,"yin":3,"setFlag":"huimen_exp_carried_in_well"},choices:[createChoice({"text":"回村街","next":"huimen_exp_village_street","effects":{"yin":1}})]}),
