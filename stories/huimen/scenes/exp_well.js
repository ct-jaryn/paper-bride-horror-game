...
你下到井底，脚踩到了硬物。那是一口红漆棺材，棺材上钉着九根桃木钉。`,effects:{"sanity":-10,"yin":3},choices:[createChoice({"text":"这就回去拿钥匙","next":"huimen_exp_return_red_coffin","condition":{"hasItem":"铜钥匙"},"effects":{"yin":1}}),createChoice({"text":"没有钥匙，先上去","next":"huimen_exp_village_street","effects":{"yin":1}}),createChoice({"text":"你已知道真相，细看井壁上更多的字","next":"huimen_exp2_well_wall","condition":{"flag":"knowsTruth"},"hidden":true,"effects":{"yin":2}})]}),
