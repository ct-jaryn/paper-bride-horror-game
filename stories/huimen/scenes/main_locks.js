...
"记录我们这些被遗忘的人。"她说，"不是超度，不是复仇，只是记住。只要有人记得，我们就不是白白的死。"`,effects:{"sanity":10,"yin":-20},choices:[createChoice({"text":"我答应你","ending":"hidden_perfect_redemption","condition":{"flag":"clues_assembled"}}),createChoice({"text":"我会把你的故事写下来","ending":"huimen_exp_redemption_loop","condition":{"flag":"clues_assembled"}})]})
};
