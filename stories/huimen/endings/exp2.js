...
huimen_exp2_ending_river_memory: createEnding('huimen_exp2_ending_river_memory', {
        title: "隐藏结局 · 河忆",
...
huimen_exp2_ending_graveyard_keeper: createEnding('huimen_exp2_ending_graveyard_keeper', {
        title: "隐藏结局 · 守坟人",
...
huimen_exp2_ending_midwife_secret: createEnding('huimen_exp2_ending_midwife_secret', {
        title: "隐藏结局 · 稳婆的忏悔",
...
huimen_exp2_ending_paper_maker_truth: createEnding('huimen_exp2_ending_paper_maker_truth', {
        title: "隐藏结局 · 纸匠遗书",
...
huimen_exp2_ending_grandma_song: createEnding('huimen_exp2_ending_grandma_song', {
        title: "隐藏结局 · 盲婆婆的歌",
...
huimen_exp2_ending_cowherd_bell: createEnding('huimen_exp2_ending_cowherd_bell', {
        title: "隐藏结局 · 牧铃",
...
huimen_exp2_ending_kitchen_smoke: createEnding('huimen_exp2_ending_kitchen_smoke', {
        title: "隐藏结局 · 炊烟",
...
huimen_exp2_ending_granary_ash: createEnding('huimen_exp2_ending_granary_ash', {
        title: "隐藏结局 · 谷灰",
...
huimen_exp2_ending_village_head_judge: createEnding('huimen_exp2_ending_village_head_judge', {
        title: "死亡结局 · 村长审判",
...
huimen_exp2_ending_child_ghost_home: createEnding('huimen_exp2_ending_child_ghost_home', {
        title: "隐藏结局 · 鬼孩归家",
...
huimen_exp2_ending_theater_shadow: createEnding('huimen_exp2_ending_theater_shadow', {
        title: "隐藏结局 · 戏影",
        text: "你陪柳红唱完了最后一出戏。\n\n戏台在月光下崩塌，柳红的戏服化作灰烬。她朝你深深一福：\"三十年了，终于有人听完我的戏。\"\n\n你把她的灰烬收进一个小瓷瓶，带出山村。后来在青石镇，你把骨灰撒进了戏台下的土里。\n\n从那以后，青石镇的戏台每年中元都会自动唱一出《游园惊梦》。有人说，那是柳红在报答你。"
    }),
huimen_exp2_ending_river_god: createEnding('huimen_exp2_ending_river_god', {
        title: "隐藏结局 · 河神",
...
huimen_exp2_ending_mountain_pact: createEnding('huimen_exp2_ending_mountain_pact', {
        title: "隐藏结局 · 山约",
        text: "你在后山禁地立了一块碑。\n\n碑上刻着三十七个名字，每一个都是周家害死的女子。你跪在碑前，发誓每年都会回来祭拜。\n\n山风很大，吹得碑文铮铮作响。你知道，那是她们在回应你。\n\n从那以后，每年清明，你都会带一束桂花来到后山。村民们说，那碑前总会多出一束不知名的野花。\n\n\"是她们回礼。\" 你说。"
    }),
huimen_exp2_ending_lantern_river: createEnding('huimen_exp2_ending_lantern_river', {
        title: "隐藏结局 · 灯河",
...
huimen_exp2_ending_seed: createEnding('huimen_exp2_ending_seed', {
        title: "隐藏结局 · 种籽",
...
huimen_exp2_ending_mirror_lake: createEnding('huimen_exp2_ending_mirror_lake', {
        title: "隐藏结局 · 镜湖",
        text: "你在河边发现了一面镜子。\n\n镜子不是普通的镜子，它是河水凝成的。你把它捞起来，照向井底。\n\n井底的秀兰看见了镜子里的自己。不是鬼，是十六岁的她，扎着辫子，笑着。\n\n\"原来我以前长这样。\" 她说，\"我都忘了。\"\n\n她把镜子接过去，镜面碎成无数片，每一片都映出她不同年纪的样子。最后一片，是她穿着嫁衣，走向光明的样子。\n\n\"谢谢你让我看见自己。\" 她说，\"我可以走了。\""
    }),
huimen_exp2_ending_white_hair: createEnding('huimen_exp2_ending_white_hair', {
        title: "隐藏结局 · 白发",
