...
export const shoumu_huling = createNPC('shoumu_huling', {
  name: '守墓狐灵',
  title: '古墓守门人',
  dialogue: {
    ...
    other_way: createDialogueNode('other_way', {
      ...
      choices: [createDialogueChoice({
        text: '问它洞在哪里',
        next: 'back_hole_location',
        condition: {
          flag: 'knowsTombBackPath'
        }
      }), createDialogueChoice({
        text: '离开',
        exit: true
    ...
    relationship: createDialogueNode('relationship', {
      text: `"青丘？"守墓狐灵的眼神柔和了一瞬，"她是我曾孙女。她母亲就是我女儿。当年周家猎狐，她母亲险些死在那场劫里，是你们周家那个猎户救了她。"它冷笑，"所以我说你们人类奇怪，一边杀我们，一边又救我们。"`,
      choices: [createDialogueChoice({
        text: '问它是否肯成全青丘',
        next: 'plea_for_qingqiu'
      }), createDialogueChoice({
        text: '离开',
        exit: true
      })]
    }),
    why_harsh: createDialogueNode('why_harsh', {
    ...
    back_hole_location: createDialogueNode('back_hole_location', {
    ...
    plea_for_qingqiu: createDialogueNode('plea_for_qingqiu', {
