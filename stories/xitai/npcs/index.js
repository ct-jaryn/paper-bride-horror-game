    ...
    lao_zhao: {
        ...
        dialogue: {
            start: {
                ...
                choices: [
                    { text: '打听当年的事', next: 'ask_past' },
                    { text: '你能帮我什么？', next: 'ask_help', condition: { flag: 'knowsArson' } },
                    { text: '离开', exit: true }
                ]
            },
            ask_past: {
                ...
                choices: [
                    { text: '谁放的火？', next: 'ask_arsonist' },
                    { text: '云袖当时怎样？', next: 'ask_yunxiu_past' },
                    { text: '回去', next: 'start' }
                ]
            },
            ask_arsonist: {
                text: '老赵摇摇头。\n\n"我没看见脸。只看见一双绸缎鞋，鞋底沾着桐油，在台板下头踱步。火起之前，那人站了整整一出《游园》的时间，像是在等戏唱到最热闹的时候才下手。"\n\n他顿了顿，压低声音："但我听见他念叨了一句——云袖不死，我女儿永无出头之日。"',
                effects: { npcAffinity: 5, setFlag: 'zhaoHeardArsonist' },
                choices: [
                    { text: '继续问云袖', next: 'ask_yunxiu_past' },
                    { text: '回去', next: 'start' }
                ]
            },
            ask_yunxiu_past: {
                ...
                choices: [
                    { text: '她为什么非要唱完？', next: 'ask_why_sing' },
                    { text: '回去', next: 'start' }
                ]
            },
            ask_why_sing: {
            ...
            ask_help: {
                ...
                effects: { npcAffinity: 10, addItem: '老赵的鼓槌' },
                choices: [
                    { text: '收下鼓槌', next: 'start' }
                ]
            }
        }
    },
    ...
    zhou_po: {
        ...
        dialogue: {
            start: {
                ...
                choices: [
                    { text: '你认识周生？', next: 'ask_zhou' },
                    { text: '纸人有什么用？', next: 'ask_paper' },
                    { text: '离开', exit: true }
                ]
            },
            ask_zhou: {
                ...
                choices: [
                    { text: '他成功了吗？', next: 'ask_fail' },
                    { text: '云袖知道吗？', next: 'ask_yunxiu_knows' },
                    { text: '回去', next: 'start' }
                ]
            },
            ask_fail: {
            ...
            ask_how_eye: {
                ...
                choices: [
                    { text: '接过朱砂笔', next: 'give_cinnabar' },
                    { text: '不要', next: 'start' }
                ]
            },
            give_cinnabar: {
                text: '"拿去吧。这是我守铺子三十年，剩的最后一点朱砂。但愿你用得上，也但愿你用不上。"',
                effects: { npcAffinity: 10, addItem: '朱砂笔' },
                choices: [
                    { text: '回去', next: 'start' }
                ]
            }
    ...
    liu_niang: {
        ...
        dialogue: {
            start: {
                ...
                choices: [
                    { text: '你是谁？', next: 'ask_identity' },
                    { text: '你父亲是刘掌柜？', next: 'ask_father', condition: { flag: 'knowsSuspects' } },
                    { text: '我陪你唱一段', next: 'sing_together' },
                    { text: '离开', exit: true }
                ]
            },
            ask_identity: {
                ...
                choices: [
                    { text: '你恨云袖吗？', next: 'ask_hate' },
                    { text: '你恨你爹吗？', next: 'ask_hate_father' },
                    { text: '回去', next: 'start' }
                ]
            },
            ask_hate: {
            ...
            ask_father: {
                ...
                effects: { npcAffinity: 5, setFlag: 'liuDaughterWitness' },
                choices: [
                    { text: '还有别的吗？', next: 'ask_father_more' },
                    { text: '回去', next: 'start' }
                ]
            },
            ask_father_more: {
            ...
            give_jade: {
                ...
                effects: { addItem: '柳娘的玉坠' },
                choices: [
                    { text: '我会转交', next: 'start' },
                    { text: '离开', exit: true }
                ]
            }
        }
