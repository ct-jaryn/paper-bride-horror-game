...
export const scenes = {
    three_souls_rite: createScene('three_souls_rite', {
        title: "群戏散",
        text: "你站在废墟正中央，依次对三个方向说话。\n\n对老生位：\"秦先生，孩子活下来了。\"\n\n对花脸位：\"赵先生，脸卸了。\"\n\n对琴师位：\"孙先生，弦续上了。\"\n\n说完，你闭上眼，静静等待。\n\n风过废墟，发出呜呜的声响，像是戏台的幕布最后一次抖动。\n\n然后，三个声音同时响起，齐齐唱了一句——\n\n[whisper]\"今日散场，各自归家。\"[/whisper]\n\n这是一句戏班的散场词。你听何伯说过，老戏班每演完一出，班主都会喊这句。\n\n可这一次，是三个亡魂，对着彼此喊的。\n\n声音渐渐远了。废墟上空，三缕青烟汇成一股，朝青石河的方向飘去。\n\n[whisper]他们去找云袖和周生了。同一个班子的，总要齐齐整整地走。[/whisper]\n\n你睁开眼，废墟恢复了真正的死寂。\n\n但这一次，是干净的死寂。\n\n你站在灵台前。\n\n灵台上摆着五张照片。五张黑白照片。五张已经褪色的面孔。一个是穿戏服的女人——云袖。一个是穿长衫的男人——秦鸣远。一个是拉二胡的瞎子——孙瞎子。一个是画花脸的武生——赵铁柱。一个是打锣鼓的女人——刘氏。\n\n五个人。五条命。一百年前。\n\n你把手里的三炷香点燃。你恭敬地拜了三拜。你把香插到香炉里。\n\n香烟袅袅升起。\n\n你闭上眼睛。你在心里说：我来渡你们。\n\n你不知道你能不能渡他们。你只是做了你该做的事。\n\n香烟升到了天花板上。然后散了。\n\n你睁开眼睛。你看着灵台上的五张照片。\n\n照片里的人在笑。不是那种礼节性的笑。是那种发自内心的笑。\n\n他们等了一百年。终于有人来渡他们了。\n\n你不知道你做的对不对。但你知道——你给了他们一个机会。\n\n一个离开的机会。\n\n你转身走出七号厅。你身后的香火还在燃。",
        effects: {
            sanity: 25,
            yin: -30,
            setFlag: "sunReleased",
