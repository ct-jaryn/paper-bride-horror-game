...
export const scenes = {
    caller_promise: createScene('caller_promise', {
        title: "应承",
        text: "\"我答应您。\"你说。\n\n电话那头沉默了很久。\n\n\"好。\"老人说，声音里带着一丝释然，\"那我就能安心了。\n\n\"孩子，我告诉你一个秘密。云袖姑娘的心愿，不是唱完一出戏，也不是有人记住她。她的心愿，是周生。\n\n\"她等的不是戏台。她等的是周生来找她。周生没来，她就一直等。可周生……\"\n\n老人的声音低了下去。\n\n\"周生也在等她。他们在同一条河里，隔着一层水，谁也没找到谁。你要是真想渡她，就带她去青石河。不是去河畔，是去河里——去他们彼此错过的地方。\"\n\n你接起了电话。\n\n\"喂？\"\n\n电话那头没有声音。只有呼吸声。\n\n\"……守夜人。\"\n\n声音很低。很远。像是从水底传来的。\n\n\"你是谁？\"\n\n\"我是林守一。\"\n\n你愣住了。林叔？\n\n\"林叔？您回来了？\"\n\n\"没有。\"电话那头的声音很疲惫。\"我只是想告诉你一件事。\"\n\n\"什么？\"\n\n\"七号厅里的那个女人——云袖。她等了一百年。她等的不是报仇。不是翻案。她等的只是一个人能'看见'她。\"\n\n\"我看见了。\"你说。\n\n电话那头沉默了。\n\n\"你看见了？\"\n\n\"是。我看见了她的记忆。看见了她等了一百年。看见了周生在河底找了她一百年。\"\n\n电话那头的呼吸变得急促了。\n\n\"那你——你会帮她吗？\"\n\n\"我会的。\"\n\n\"……谢谢。\"\n\n电话挂断了。\n\n你握着电话站在值班室里。你不知道林叔在哪里。你不知道他为什么打电话。\n\n但你知道——你不是一个人在做这件事。\n\n在你之前，有七代守夜人。每一个人都试图帮云袖。每一个人都失败了。\n\n你是第八代。你是最后一个。\n\n你要完成他们未竟的使命。",
        effects: {
            sanity: 5,
            yin: -5,
