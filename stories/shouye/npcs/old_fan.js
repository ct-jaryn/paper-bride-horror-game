...
"春香班！哎呀，那是多少年前的事了。"何伯拍着大腿，"我年轻时候，追着春香班跑了半个县，就为了听云袖姑娘一出《牡丹亭》。"`,
      ...
      fan_yunxiu_voice: createDialogueNode('fan_yunxiu_voice', {
...
"我记得她唱《惊梦》，唱到'良辰美景奈何天'，我在台下，眼泪就下来了。那时候我不懂什么叫好戏，可我就是想哭。后来我才明白，那是唱到了人心里去。"`,
      ...
      fan_fire: createDialogueNode('fan_fire', {
        text: `何伯的脸色暗下来。
...
"后来有个年轻人冲上去救她。听说是纸扎铺的周生。再后来，戏台塌了，火光里什么都看不见了。云袖姑娘和周生，都没出来。"`,
      ...
      fan_zhousheng: createDialogueNode('fan_zhousheng', {
...
"要是没那场火，他们早成亲了，没准儿现在孙子都有了。哪至于……一个泡在河里，一个不知所踪。"`,
      ...
      fan_zhousheng_river: createDialogueNode('fan_zhousheng_river', {
        text: `你把周生投河的事告诉何伯。
...
"这是云袖姑娘最后那场戏的票。我留了一辈子。你拿去，替我烧给她。告诉她，何伯这辈子，没忘了她的戏。"`,
        choices: [createDialogueChoice({
          ...
          effects: {
            ...
            npcAffinity: 20,
            sanity: 10,
            setFlag: 'fanGaveTicket'
          }
        })]
      }),
      fan_others_remember: createDialogueNode('fan_others_remember', {
...
"再就是省城有个戏曲研究所，前些年来人问过云袖姑娘的事，说是要写进什么书里。你若有心，可以去那边问问。"`,
        choices: [createDialogueChoice({
          ...
          effects: {
            npcAffinity: 10,
            setFlag: 'fanHintedDescendant'
          }
        })]
      }),
      fan_can_sing: createDialogueNode('fan_can_sing', {
        text: `何伯愣了一下，然后清了清嗓子。
