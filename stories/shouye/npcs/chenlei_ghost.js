...
export const NPCs = {
  chenlei_ghost: createNPC('chenlei_ghost', {
    name: '陈磊',
    title: '三号厅 · 车祸少年',
    dialogue: {
...
"叔叔……您能听见我？白天我妈来的时候，她听不见。只有您能听见。"`,
      ...
      cl_worry: createDialogueNode('cl_worry', {
...
"小月飞出去的时候，我还伸手去抓她。可我抓了个空。然后我也撞上去了。"`,
      ...
      cl_girlfriend: createDialogueNode('cl_girlfriend', {
...
"可如果那天我骑慢一点……"`,
      ...
      cl_xiaoyue_forgive: createDialogueNode('cl_xiaoyue_forgive', {
        text: `"小月……不怪我？"少年的声音颤抖。
...
"还有小月……如果有下辈子，我还送她回家。这次，我一定骑慢一点。"`,
      ...
      cl_mother: createDialogueNode('cl_mother', {
...
"还有我屋里那个摩托车模型，是我自己拼的。让她别扔了，送给我表弟吧。他一直想要。"`,
        choices: [createDialogueChoice({
          ...
          effects: {
            npcAffinity: 15,
            sanity: 10,
            setFlag: 'chenleiMotherMessage'
          }
        })]
      }),
      cl_age: createDialogueNode('cl_age', {
