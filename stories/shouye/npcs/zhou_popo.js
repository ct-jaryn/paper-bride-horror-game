...
export const NPCs = {
  zhou_popo: createNPC('zhou_popo', {
    ...
    dialogue: {
      ...
      popo_tishen: createDialogueNode('popo_tishen', {
      ...
      popo_price: createDialogueNode('popo_price', {
        ...
        choices: [createDialogueChoice({
          ...
          effects: {
            npcAffinity: 10,
            setFlag: 'promisedReturnZhouSheng'
          }
        }), createDialogueChoice({
          text: '我只想要纸人',
          next: 'popo_greedy',
      ...
      popo_greedy: createDialogueNode('popo_greedy', {
      ...
      popo_zhousheng: createDialogueNode('popo_zhousheng', {
      ...
      popo_mirror: createDialogueNode('popo_mirror', {
        ...
        choices: [createDialogueChoice({
          ...
          effects: {
            npcAffinity: 5,
            setFlag: 'popoHintedMirror'
          }
        })]
      }),
      popo_letter: createDialogueNode('popo_letter', {
        text: `"信在我这里，但只有真心想送还的人，才能拆开。你若念给她听，比烧一百叠纸钱都管用。"`,
        choices: [createDialogueChoice({
          text: '请把信给我',
          next: 'popo_give_letter',
          condition: {
            flag: 'promisedReturnZhouSheng'
          }
        }), createDialogueChoice({
          text: '我会再来',
          exit: true
      ...
      popo_give_letter: createDialogueNode('popo_give_letter', {
      ...
      popo_newspaper: createDialogueNode('popo_newspaper', {
